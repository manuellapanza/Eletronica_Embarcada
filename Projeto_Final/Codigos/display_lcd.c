...
int main(void)
{
    ...
    InitLCD();
     while(1)
    {
        // Colocar função para cada condição
        //Escrever de acordo com cada cor do led
        // Para cor azul escrever "Calibrar"
        // Para cor verde escrever "Verdade"
        // Para cor vermelho escrever "Nervosismo"

        // Transmite a string
        CLR_DISPLAY;
        POS0_DISPLAY;
        Send_Int(i++);
        // Alterar para cada resultado
        Send_String("Resultado");
    }
    return 0;
}
